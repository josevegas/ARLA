    ...
    <div className="flex items-center justify-center min-h-[60vh] px-4">
      <NeumorphicCard className="w-full max-w-md p-10">
        ...
        <form onSubmit={handleVerify} className="space-y-8">
          ...
          {error && <p className="text-center text-terracotta font-bold text-sm">{error}</p>}

          <NeumorphicButton type="submit" className="w-full py-4 bg-forest-green text-white font-black uppercase tracking-widest">
            Verificar Ahora
          </NeumorphicButton>
        </form>
